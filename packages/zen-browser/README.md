...
The COPR project behind [`zen-browser`](zen-browser/README.md), the only package it holds.

## COPR project

Create a COPR project named `zen-browser` under the owner set in the `COPR_OWNER` repository variable. Its name is both this directory and the `Project` field of the package definition; the two must agree.

| Setting            | Value                                                                               |
| ------------------ | ----------------------------------------------------------------------------------- |
| Chroots            | `fedora-43-x86_64`, `fedora-44-x86_64`, `fedora-45-x86_64`, `fedora-rawhide-x86_64` |
| Build dependencies | Fedora only                                                                         |
| Network            | Not needed; the build repackages a downloaded archive offline                       |
